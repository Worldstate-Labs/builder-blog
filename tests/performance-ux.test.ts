...
test("settings live in the clickable user avatar menu", () => {
  ...
  assert.match(skillPromptActions, /Fetches posts this many days back/);
  assert.doesNotMatch(skillPromptActions, /Parallel workers|1 worker|workers`|Use 1 for the safest setup|Looks back this many days for posts/);
