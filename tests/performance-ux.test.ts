...
test("settings live in the clickable user avatar menu", () => {
  ...
  assert.match(globals, /\.access-key-card\s*{[\s\S]*grid-template-columns:\s*2\.5rem minmax\(0,\s*1fr\) max-content/);
  ...
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-card\s*{[\s\S]*grid-template-columns:\s*2\.5rem minmax\(0,\s*1fr\)/);
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-card\s*{[\s\S]*min-height:\s*5\.75rem/);
...
test("builders page exposes per-builder fetched posts ordered by time", () => {
  ...
  assert.match(searchPage, /<PostFavoriteControl[\s\S]*feedItemId=\{result\.id\}[\s\S]*initialIsFavorite=\{Boolean\(result\.favoritedAt\)\}/);
  ...
  assert.match(postDetailPage, /<PostFavoriteControl[\s\S]*feedItemId=\{item\.id\}[\s\S]*initialIsFavorite=\{Boolean\(favorite\)\}/);
...
test("settings mutations stay local instead of refreshing the whole route", () => {
  ...
  assert.match(settingsPage, /className="access-key-card access-key-card--skeleton"/);
  assert.match(settingsPage, /className="access-key-skeleton-icon"/);
  assert.match(settingsPage, /settings-skeleton-line--device-title/);
  assert.match(settingsPage, /settings-skeleton-line--device-status/);
  assert.match(settingsPage, /className="settings-skeleton-pill access-key-skeleton-pill"/);
  ...
  assert.match(globals, /\.access-key-skeleton-icon\s*{[\s\S]*height:\s*2\.5rem/);
  ...
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-card--skeleton\s*{[\s\S]*min-height:\s*5\.75rem/);
  ...
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-card\s*{[\s\S]*min-height:\s*5\.75rem/);
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-revoke-button,[\s\S]*\.access-key-revoked-pill\s*{[\s\S]*grid-column:\s*2/);
  assert.match(globals, /@media \(max-width:\s*767px\)[\s\S]*\.access-key-revoke-button,[\s\S]*\.access-key-revoked-pill\s*{[\s\S]*min-height:\s*2\.45rem/);
