...
test("dashboard defers heavy recommendation timeline work to a client island", () => {
  ...
  assert.match(favoritesSection, /@\/components\/EmptyState/);
  assert.match(favoritesSection, /<EmptyState/);
  ...
  assert.match(followingSection, /@\/components\/EmptyState/);
...
test("builders page exposes per-builder fetched posts ordered by time", () => {
  ...
  assert.match(recommendationItemPage, /@\/components\/PageHeader/);
  assert.match(recommendationItemPage, /<PageHeader[\s\S]*className="reading-page-head"[\s\S]*title="Post"/);
  assert.doesNotMatch(recommendationItemPage, /className="reading-page-nav"/);
  ...
  assert.match(globals, /\.reading-page-head\s*{[\s\S]*margin-bottom:\s*1\.35rem/);
  assert.doesNotMatch(globals, /\.reading-page-nav\s*{/);
