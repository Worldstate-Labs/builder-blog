...
test("library hub exposes share and multi-import flows", () => {
  ...
  assert.match(digestPipelineForm, /Import collections to see them in the AI Digest tab\./);
  ...
  assert.match(digestPipelineForm, /Shared collections appear here after users share them to Hub\./);
