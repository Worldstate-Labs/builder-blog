...
test("workspace not-found uses the FollowBrief shell instead of the default Next 404", () => {
  ...
  assert.match(notFoundPage, /This page is unavailable or outside your sources or AI Brief collections\./);
...
test("desktop shell uses centered top navigation and merged home feeds", () => {
  ...
  assert.match(digestPipelineSelector, /aria-label=\{`AI Brief collection: \$\{selectedLabel\}`\}/);
  assert.match(digestPipelineSelector, /aria-label=\{`Choose AI Brief collection, current: \$\{selectedLabel\}`\}/);
...
test("dashboard digest tab owns the AI Brief selector", () => {
  ...
  assert.match(digestPipelineVisibilityToggle, /Could not update AI Brief collection sharing\./);
  assert.doesNotMatch(digestPipelineVisibilityToggle, /AI Brief archive/);
  assert.doesNotMatch(digestPipelineVisibilityToggle, /Unable to update AI Brief sharing|Unable to update digest pipeline sharing/);
  assert.doesNotMatch(digestPipelineVisibilityToggle, /className="hub-share-button"/);
  assert.match(dashboardPage, /displayDigestPipelineTitle\(ownPipelineShare\?\.title \?\? "AI Brief"\)/);
  assert.match(dashboardPage, /function displayDigestTitle\(title: string\)[\s\S]*return displayDigestPipelineTitle\(title\)/);
  assert.match(dashboardPage, /ownerLabel: "Your AI Brief collection"/);
  assert.doesNotMatch(dashboardPage, /ownerLabel: "Your AI Brief"/);
  assert.match(dashboardPage, /Imported AI Brief collection, read-only\./);
  assert.doesNotMatch(dashboardPage, /ownPipelineShare\?\.title \?\? "Digest"|Imported digest view|Imported AI Brief view|Own digest/);
  ...
  assert.match(buildersPage, /Your AI Brief collection/);
  ...
  assert.match(digestPipelineForm, /Brief collections imported from Hub\./);
...
test("primary tabs keep local loading fallbacks alongside route loaders", () => {
  ...
  assert.match(libraryHubPage, /Import shared source libraries for AI Brief and Following\./);
  ...
  assert.doesNotMatch(libraryHubPage, /label:\s*"AI Brief archives"/);
  assert.doesNotMatch(libraryHubPage, /label:\s*"AI Briefs"/);
  ...
  assert.match(libraryHubPage, /<span className="sr-only">Loading shared AI Brief collections<\/span>/);
  assert.match(libraryHubPage, /Import shared source libraries for AI Brief and Following\./);
  ...
  assert.match(libraryHubPage, /<h2 className="fb-section-heading">Shared AI Brief collections<\/h2>/);
  assert.doesNotMatch(libraryHubPage, /<h2 className="fb-section-heading">AI Brief archives<\/h2>/);
  assert.match(libraryHubPage, /Import AI Brief collections shared by others\./);
  assert.doesNotMatch(libraryHubPage, /AI Brief tab|Import shared AI Brief collections\.|Import shared collections\.|Import shared AI Brief collections into AI Brief\./);
  ...
  assert.match(source("src/components/LibraryHubImportForm.tsx"), /Import shared source libraries for AI Brief and Following\./);
  ...
  assert.match(source("src/components/DigestPipelineImportForm.tsx"), /Import AI Brief collection \$\{pipeline\.title\}/);
...
test("library hub exposes share and multi-import flows", () => {
  ...
  assert.match(digestPipelineForm, /DigestPipelineTitleEditor/);
  assert.match(digestPipelineTitleEditor, /AI Brief collection name/);
  assert.match(digestPipelineTitleEditor, /Save AI Brief collection name/);
  assert.match(digestPipelineTitleEditor, /Edit AI Brief collection name/);
  assert.match(digestPipelineTitleEditor, /Enter an AI Brief collection name\./);
  assert.match(digestPipelineTitleEditor, /Could not save AI Brief collection name\./);
  assert.doesNotMatch(digestPipelineTitleEditor, /AI Brief name/);
  assert.doesNotMatch(digestPipelineTitleEditor, /AI Brief collection name cannot be empty|Could not rename AI Brief/);
  ...
  assert.match(digestPipelineForm, /Imported AI Brief collections/);
  assert.match(digestPipelineForm, /Import AI Brief collections shared by others\./);
  assert.match(digestPipelineForm, /Brief collections imported from Hub\./);
  assert.doesNotMatch(digestPipelineForm, /AI Brief tab|Import shared AI Brief collections\.|Import shared collections\.|Import shared AI Brief collections into AI Brief\.|Available in AI Brief\.|Already in AI Brief\.|Collections already in AI Brief\./);
  assert.doesNotMatch(digestPipelineForm, /Archives already in AI Brief\.|Archives already available in AI Brief\./);
  assert.doesNotMatch(digestPipelineForm, /AI Brief archives shared to Hub\.|AI Brief archives already imported from Hub\./);
  assert.doesNotMatch(digestPipelineForm, /AI Brief archives you imported from Hub\./);
  assert.doesNotMatch(digestPipelineForm, /Digests imported from the Hub/);
  assert.doesNotMatch(digestPipelineForm, /latest AI Brief and archive/);
  assert.match(digestPipelineForm, /Shared AI Brief collections/);
  ...
  assert.match(source("src/lib/library-hub.ts"), /adminCommunityDigestTitle = "Community AI Brief"/);
  ...
  assert.match(digestPipelineForm, /No imported AI Brief collections/);
  assert.match(digestPipelineForm, /Import a collection from Hub\./);
  assert.doesNotMatch(digestPipelineForm, /Imported AI Brief collections appear here\.|Import AI Brief collections to see them here\.|Import one to see it in AI Brief\.|Import collections to see them in AI Brief\.|Import archives to see them in AI Brief\./);
  assert.doesNotMatch(digestPipelineForm, /Import an AI Brief archive from Hub to see it on Home\./);
  ...
  assert.match(digestPipelineForm, /Browse AI Brief collections/);
  assert.doesNotMatch(digestPipelineForm, /Browse Hub/);
  assert.match(digestPipelineForm, /No shared AI Brief collections/);
  assert.match(digestPipelineForm, /No shared AI Brief collections yet\./);
  assert.doesNotMatch(digestPipelineForm, /Shared AI Brief collections appear here\.|AI Brief collections shared to Hub appear here\.|AI Brief collections appear here after users share them to Hub\.|Shared collections appear here\.|Shared collections appear here after users share them to Hub\.|Shared AI Brief archives appear here when users share them to Hub\.|Archives appear here after users share them to Hub\.|Shared AI Brief collections appear here after they are shared to Hub\.|Shared AI Brief collections appear here when people share them to Hub\./);
  assert.match(digestPipelineForm, /No AI Briefs yet/);
  assert.doesNotMatch(digestPipelineForm, /No AI Brief archives yet/);
  assert.doesNotMatch(digestPipelineForm, /No AI Brief archives yet/);
  ...
  assert.match(digestPipelineForm, /actionGroupLabel=\{`AI Brief collection actions for \$\{pipeline\.title\}`\}/);
  assert.match(digestPipelineForm, /className="fb-hub-card-actions"[\s\S]*role="group"/);
  assert.match(digestPipelineForm, /aria-label=\{`Import AI Brief collection \$\{pipeline\.title\}`\}/);
  assert.match(digestPipelineForm, /aria-pressed=\{false\}/);
  assert.match(digestPipelineForm, /\?\s*"Importing"\s*:\s*"Import"/);
  assert.doesNotMatch(digestPipelineForm, /aria-label=\{`Import \$\{pipeline\.title\}`\}|: "Import AI Brief archive"|Importing collection|Import collection|Importing AI Brief archive|Import archive/);
  ...
  assert.match(digestPipelineForm, /Remove imported AI Brief collection\?/);
  assert.match(digestPipelineForm, /removes this collection\s+from AI Brief\./);
  assert.doesNotMatch(digestPipelineForm, /no longer see this AI Brief archive in AI Brief\./);
  assert.doesNotMatch(digestPipelineForm, /no longer see this AI Brief archive on Home\./);
  ...
  assert.match(digestPipelineForm, /aria-label=\{`Remove imported AI Brief collection \$\{pipeline\.title\}`\}/);
  assert.match(digestPipelineForm, /aria-pressed=\{true\}/);
  assert.match(digestPipelineForm, /\?\s*"Removing"\s*:\s*"Imported"/);
  assert.match(digestPipelineForm, />\s*Remove import\s*<\/button>/);
  assert.match(digestPipelineForm, /Could not import AI Brief collection/);
  assert.match(digestPipelineForm, /Could not remove imported AI Brief collection/);
  assert.doesNotMatch(digestPipelineForm, /AI Brief collection import|Remove \$\{pipeline\.title\} from Home|Remove \$\{pipeline\.title\} from imported AI Briefs|Remove imported digest\?|Remove imported AI Brief\?|Remove digest|>\s*Remove AI Brief\s*<\/button>|Could not import digest|Could not remove imported digest|no longer see this digest on the Home page|no longer see this AI Brief archive on the Home page|you will\s+no longer see this collection/);
  ...
  assert.match(source("src/lib/library-hub.ts"), /adminCommunityDigestTitle = "Community AI Brief"/);
  assert.match(source("src/lib/library-hub.ts"), /"Community AI Brief curated by FollowBrief\."/);
  ...
  assert.match(source("src/lib/library-hub.ts"), /\$\{identity\}'s AI Brief/);
