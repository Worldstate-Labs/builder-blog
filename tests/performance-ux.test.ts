...
test("public entry pages use the centered product layout", () => {
  ...
  assert.match(landingPage, /<I18nText id="home\.worksWith" \/>/);
  assert.match(landingPage, /\["x", "blog", "youtube", "podcast", "website"\]/);
  assert.match(landingPage, /className="fb-kind-pill"/);
  assert.match(landingPage, /className="lp-film" id="film"/);
  assert.match(landingPage, /<I18nText id="home\.filmLabel" \/>/);
  assert.match(landingPage, /<I18nText id="home\.filmNote" \/>/);
  assert.match(landingPage, /className="lp-film-frame"/);
  assert.match(landingPage, /className="lp-film-chrome" aria-hidden="true"/);
  assert.match(landingPage, /followbrief\.worldstatelabs\.com — everyone you follow, one brief/);
  ...
  assert.match(landingPage, /<I18nText id="home\.loopNote" \/>/);
  ...
  assert.match(landingPage, /className="lp-cta-url">followbrief\.worldstatelabs\.com</);
  assert.match(landingPage, /className="lp-footer"/);
  assert.match(landingPage, /© 2026 FollowBrief/);
