...
test("primary tabs keep local loading fallbacks alongside route loaders", () => {
  ...
  assert.match(libraryHubPage, /Import shared source libraries into the Sources tab\. They feed AI Digest issues and Following posts\./);
  ...
  assert.match(libraryHubPage, /<PageHeader[\s\S]*title="Hub"[\s\S]*Browse shared source libraries and AI Digest collections/);
  ...
  assert.match(source("src/components/LibraryHubImportForm.tsx"), /Import shared source libraries into the Sources tab\. They feed AI Digest issues and Following posts\./);
...
test("library hub exposes share and multi-import flows", () => {
  ...
  assert.match(digestPipelineForm, /Import one to see it in the AI Digest tab\./);
  assert.doesNotMatch(digestPipelineForm, /Import collections to see them in the AI Digest tab\.|Import archives to see them in AI Digest\./);
  ...
  assert.match(digestPipelineForm, /AI Digest collections appear here after users share them to Hub\./);
  assert.doesNotMatch(digestPipelineForm, /Shared collections appear here after users share them to Hub\.|Shared AI Digest archives appear here when users share them to Hub\.|Archives appear here after users share them to Hub\./);
  assert.match(digestPipelineForm, /No AI Digest issues yet/);
  assert.doesNotMatch(digestPipelineForm, /No AI Digest archives yet/);
