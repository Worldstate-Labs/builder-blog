...
test("dashboard digest tab owns the AI Brief selector", () => {
  ...
  assert.match(buildersPage, /className="digest-source-management digest-brief-list"/);
  assert.match(buildersPage, /<FollowBriefDigestPipelineCard pipeline=\{data\.followBriefDigestPipeline\} \/>/);
  assert.doesNotMatch(buildersPage, /your-digest-panel|imported-digest-panel/);
  assert.match(digestPipelineForm, /FollowBrief AI Brief/);
...
test("primary tabs keep local loading fallbacks alongside route loaders", () => {
  ...
  assert.match(digestPipelineForm, /export function FollowBriefDigestPipelineCard/);
  ...
  assert.match(digestPipelineForm, /title: "FollowBrief AI Brief"/);
  assert.match(digestPipelineForm, /@\/components\/DigestHeadlineSummary/);
  ...
  assert.match(digestPipelineForm, /followbrief-digest-card/);
  ...
  assert.match(source("src/components/DigestPipelineImportForm.tsx"), /className="own-digest-card"[\s\S]*followbrief-digest-card/);
