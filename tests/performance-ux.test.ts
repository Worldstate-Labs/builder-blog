...
test("builders page exposes per-builder fetched posts ordered by time", () => {
  ...
  assert.match(postCard, /<p className="post-detail-section-desc">Saved by Fetch sources\.<\/p>/);
  ...
  assert.match(cssRule(globals, ".post-detail-section-desc"), /font-size:\s*var\(--text-role-control-size\)/);
