...
test("public entry pages use the centered product layout", () => {
  ...
  assert.match(loginPage, /sources,\s*posts, and AI Digest issues searchable/);
  ...
  assert.match(rootLayout, /Follow sources, read the cited AI Digest, and search sources, posts, and AI Digest issues\./);
