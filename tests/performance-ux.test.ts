...
test("settings mutations stay local instead of refreshing the whole route", () => {
  ...
  assert.match(globals, /\.access-keys-list--skeleton \.settings-skeleton-row\s*{[\s\S]*height:\s*6\.5rem/);
  ...
  assert.match(tokenPanel, /className="access-keys-list" role="list" aria-label="Access keys for Local Agents"/);
