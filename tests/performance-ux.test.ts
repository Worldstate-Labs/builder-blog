...
test("search page uses a client form with pending feedback", () => {
  ...
  assert.match(searchPage, /Try broader terms or all results\./);
...
test("primary tabs keep local loading fallbacks alongside route loaders", () => {
  ...
  assert.match(libraryHubPage, /Import shared libraries into Sources for AI Digest and Following\./);
  ...
  assert.match(libraryHubPage, /Import shared collections into AI Digest\./);
  ...
  assert.match(source("src/components/LibraryHubImportForm.tsx"), /Import shared libraries into Sources for AI Digest and Following\./);
...
test("library hub exposes share and multi-import flows", () => {
  ...
  assert.match(hubImportForm, /its sources\s+no longer appear in Sources or feed AI Digest and Following\./);
  ...
  assert.match(hubImportForm, /Import this library from Hub again\./);
  ...
  assert.match(libraryImportRemoveButton, /its sources no longer\s+appear in Sources or feed AI Digest and Following\./);
  ...
  assert.match(libraryImportRemoveButton, /Import this library from Hub again\./);
  ...
  assert.match(digestPipelineForm, /Import shared collections into AI Digest\./);
  ...
  assert.match(digestPipelineForm, /Import this collection from Hub again\./);
