...
test("web app serves the agent skill and setup command", () => {
  ...
  assert.match(skillPromptRenderer, /openclaw cron add --help/);
  assert.match(skillPromptRenderer, /--session current/);
  assert.match(skillPromptRenderer, /--session main/);
  assert.match(skillPromptRenderer, /--system-event/);
  assert.match(skillPromptRenderer, /--wake now/);
  assert.doesNotMatch(skillPromptRenderer, /--session isolated/);
  assert.doesNotMatch(skillPromptRenderer, /--light-context/);
