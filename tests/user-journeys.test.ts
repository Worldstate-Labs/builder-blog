...
test("web app serves the agent skill and setup command", () => {
  ...
  assert.match(skillPromptActions, /Copy cron command/);
  assert.match(skillPromptActions, /\/api\/skill\/bootstrap/);
  assert.match(skillPromptActions, /BUILDER_BLOG_PROMPT_URL/);
  assert.match(skillPromptActions, /builder-blog-library-once\.md/);
  assert.match(skillPromptActions, /builder-blog-library-cron-setup\.md/);
  assert.match(skillPromptActions, /builder-blog-digest-once\.md/);
  assert.match(skillPromptActions, /builder-blog-digest-cron-setup\.md/);
  assert.match(skillPromptActions, /builder-agent-runner\.sh \$\{job\}/);
