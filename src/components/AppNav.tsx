...
import { Archive, Home, KeyRound, LibraryBig, Search, ShieldCheck, Sparkles, UsersRound } from "lucide-react";

export type AppNavItem = {
  href: string;
  label: string;
  icon: "home" | "archive" | "recommendations" | "builders" | "hub" | "search" | "key" | "admin";
};
