...
export function DigestPipelineImportForm({
  ...
  const description =
    mode === "imported"
      ? "AI Digest archives from Hub that are already available on Home."
  ...
  const emptyMessage =
    mode === "imported"
      ? "Import AI Digest archives built and shared by other users to see them on Home."
  ...
  return (
    <article className="own-digest-card">
      ...
      <div className="fb-hub-card-stats">
        <CountMeta
          label={pipeline.digestCount === 1 ? "AI Digest archive" : "AI Digest archives"}
