...
export const privacyIntro =
  "Last updated: July 7, 2026. This policy explains what FollowBrief collects, why it is used, how Hub sharing works, and how you can access, export, correct, or delete account data. Contact: jie@worldstatelabs.com.";
...
export const termsIntro =
  "Last updated: July 7, 2026. These terms cover your use of FollowBrief, Local Agent access, Hub sharing, third-party sources, third-party APIs, and AI Digest output. Contact: jie@worldstatelabs.com.";
