...
const FETCH_FAILURE_TAXONOMY = {
  ...
  asr_capability_missing: {
    category: "runtime",
    stage: "read",
    userMessage: "Local media tools need setup",
    operatorMessage: "The FollowBrief runner could not find a verified downloader, decoder, and local speech backend on this machine.",
    retryable: false,
    notCompleted: true,
  },
  managed_asr_lock_timeout: {
    category: "runtime",
    stage: "read",
    userMessage: "Local media preparation was busy for too long",
    operatorMessage: "The machine-wide speech transcription lock did not become available within the task budget.",
    retryable: true,
    notCompleted: true,
  },
  managed_media_preparation_failed: {
    category: "runtime",
    stage: "read",
    userMessage: "Local media preparation failed",
    operatorMessage: "The deterministic FollowBrief media runner failed before model summarization started.",
    retryable: true,
    notCompleted: true,
  },
  runtime_auth_failed: {
  ...
  runtime_model_incompatible: {
    category: "runtime",
    stage: "runtime",
    userMessage: "The installed Codex could not run the selected model",
    operatorMessage: "The installed Codex version or account model catalog was incompatible with the selected economical model.",
    retryable: true,
    notCompleted: true,
  },
  runtime_interrupted: {
  ...
  worker_runtime_failed: {
    category: "worker",
    stage: "runtime",
    userMessage: "Local Agent exited before this post finished",
    operatorMessage: "The worker process exited before writing a complete shard result; its exit evidence was preserved.",
    retryable: true,
    notCompleted: true,
  },
