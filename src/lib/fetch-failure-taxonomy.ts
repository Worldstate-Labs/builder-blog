...
const FETCH_FAILURE_TAXONOMY = {
  ...
  worker_no_progress_timeout: {
    category: "worker",
    stage: "runtime",
    userMessage: "Local Agent made no checkpoint progress for this post",
    operatorMessage: "The worker did not write a result, task checkpoint, or progress checkpoint before the no-progress timeout.",
    retryable: true,
    notCompleted: true,
  },
  worker_stalled_timeout: {
    category: "worker",
    stage: "runtime",
    userMessage: "Local Agent stopped making checkpoint progress for this post",
    operatorMessage: "The worker wrote progress for the shard, then stopped updating result, task checkpoint, or progress files before finishing every task.",
    retryable: true,
    notCompleted: true,
  },
