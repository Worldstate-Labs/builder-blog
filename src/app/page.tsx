          ...
          <div className="fb-product-preview-list">
            {[
              ...
              },
              {
                ...
                detail:
                  "Find sources, posts you've saved, and past AI Digests when you need the detail later.",
              },
            ].map((item) => (
      ...
      <section className="fb-public-section fb-public-workspace">
        ...
        <div className="fb-public-feature-grid">
          ...
          <Feature
            ...
            copy="Sources, posts, saved posts, and AI Digests share one search surface."
          />
        </div>
      </section>
    </main>
